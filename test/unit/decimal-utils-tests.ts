...
describe('Decimal Utilities', () => {
    ...
    describe('negateDecimal', () => {
        ...
        test('negates negative values back to positive', () => {
            const negative = new Uint32Array([0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF]);
    ...
    describe('toDecimalString', () => {
        ...
        test('formats negative values with minus sign', () => {
            ...
            const negative = new Uint32Array([0xFFFFFFD6, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF]);
    ...
    describe('Integration tests', () => {
        ...
        test('double negation returns to original', () => {
            ...
            expect(toDecimalString(doubleNegated, 2)).toBe(toDecimalString(original, 2));
        });
    });
});
