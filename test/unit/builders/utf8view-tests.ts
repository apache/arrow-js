...
import { Vector, Utf8View } from 'apache-arrow';
...
describe('Utf8ViewBuilder', () => {
    runTestsWithEncoder('encodeAll', encodeAll(() => new Utf8View()));
    runTestsWithEncoder('encodeEach: 5', encodeEach(() => new Utf8View(), 5));
    runTestsWithEncoder('encodeEach: 25', encodeEach(() => new Utf8View(), 25));
    runTestsWithEncoder('encodeEach: undefined', encodeEach(() => new Utf8View(), void 0));
    testDOMStreams && runTestsWithEncoder('encodeEachDOM: 25', encodeEachDOM(() => new Utf8View(), 25));
    testNodeStreams && runTestsWithEncoder('encodeEachNode: 25', encodeEachNode(() => new Utf8View(), 25));
});

function runTestsWithEncoder(name: string, encode: (vals: (string | null)[], nullVals?: any[]) => Promise<Vector<Utf8View>>) {
