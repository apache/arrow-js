...
describe('Visitor', () => {
    ...
    describe('uses the base methods when no feature methods are implemented', () => {
        ...
        test(`visits LargeList types`, () => validateBasicVisitor(new LargeList(null as any)));
    ...
    describe(`uses the feature methods instead of the base methods when they're implemented`, () => {
        ...
        test(`visits LargeList types`, () => validateFeatureVisitor(new LargeList(null as any)));
